...
$sumSQL = "select  sum(Roll N0) as totalRoll from students";
...
$avgSQL = "select  AVG(Roll N0) as totalRoll from students";
...
$maxSQL = "select  max(Roll N0) as totalRoll from students";
...
$minSQL = "select  MIN(Roll No) as totalRoll from students";
